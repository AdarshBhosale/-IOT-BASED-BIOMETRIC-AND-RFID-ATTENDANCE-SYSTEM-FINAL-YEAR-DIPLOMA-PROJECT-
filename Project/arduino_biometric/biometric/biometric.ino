...
#define buzzer 16 //D0  for buzzer
...
const char *ssid = "Inext";  //ENTER YOUR WIFI SETTINGS
const char *password = "passw0rd15";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.43.209/biometricattendance/getdata.php"; //computer IP or the server domain
...
int getFingerprintID() {
  ...
  if (p == FINGERPRINT_OK) {
    Serial.println("Found a print match!");                               ///////////////we can put or function here///////////////////////////////
